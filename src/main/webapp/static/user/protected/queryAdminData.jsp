<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <body>
        ...
        <div class="content" align="center">
            <h2>查詢管理員資料</h2>
            <form method="get" action="/CloudSerenityHotel/admin/queryAllAdmin">
                <button type="submit">查詢全部資料</button>
            </form>
            <form method="post" action="/CloudSerenityHotel/admin/queryAdminById">
                <p>以使用者編號查詢</p>
                <input type="number" min="1" name="id" placeholder="請輸入使用者編號" required />
                <button type="submit">查詢</button>
            </form>
            <form method="post" action="/CloudSerenityHotel/admin/queryAdminByName">
                <p>以使用者名稱查詢</p>
